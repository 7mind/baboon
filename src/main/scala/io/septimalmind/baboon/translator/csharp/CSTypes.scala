...
object CSTypes {
  ...
  val iBaboonCodec: CSType           = CSType(baboonRuntimePkg, "IBaboonCodec", fq = false, None)
  val iBaboonValueCodec: CSType      = CSType(baboonRuntimePkg, "IBaboonValueCodec", fq = false, None)
  val iBaboonStreamCodec: CSType     = CSType(baboonRuntimePkg, "IBaboonStreamCodec", fq = false, None)
  ...
  val iBaboonTypeCodecs: CSType    = CSType(baboonRuntimePkg, "IBaboonTypeCodecs", fq = false, None)
  val baboonTypeCodecs: CSType     = CSType(baboonRuntimePkg, "BaboonTypeCodecs", fq = false, None)
  val abstractBaboonCodecs: CSType = CSType(baboonRuntimePkg, "AbstractBaboonCodecs", fq = false, None)
  val baboonSingleton: CSType      = CSType(baboonRuntimePkg, "BaboonSingleton", fq = false, None)
