...
class CrossLanguageTest {
    ...
    private fun readAnyShowcaseUeba(source: String): AnyShowcase {
        ...
        val r = BaboonBinaryReader(file.readBytes())
        return AnyShowcase_UEBACodec.decode(ctx, r)
    }

    private fun decodeInner(o: AnyOpaque): InnerPayload {
        return when (o) {
            is AnyOpaqueUeba -> InnerPayload_UEBACodec.decode(BaboonCodecContext.Compact, BaboonBinaryReader(o.bytes))
    ...
    @Test fun anyShowcaseKmpJson()    = assertAnyShowcase("kotlin-kmp", "JSON", readAnyShowcaseJson("kotlin-kmp"))
    @Test fun anyShowcaseKmpUeba()    = assertAnyShowcase("kotlin-kmp", "UEBA", readAnyShowcaseUeba("kotlin-kmp"))
    ...
    @Test fun anyShowcaseUebaByteIdenticalKmpScala() {
        val k = File(baseDir, "kotlin-kmp-ueba/any-showcase.ueba").readBytes()
