...
from BaboonTests.custom_containers import ResultOk, ResultErr, ResultServiceRt


class MockI1(I1):
    def testCall(self, arg):
        return ResultOk(I1_Out(i00=42))

    def testCall2(self, arg):
        return ResultOk(T7_Empty())


class FailingI1(I1):
    def testCall(self, arg):
        return ResultErr(I1_Err(msg="domain error"))

    def testCall2(self, arg):
        return ResultErr(T7_Empty())
...
class ResultWiringTests(unittest.TestCase):
    ...
    def test_i1_json_testCall_success(self):
        ...
        self.assertIsInstance(result, ResultOk)
    ...
    def test_i1_json_domain_error(self):
        ...
        method = BaboonMethodId("I1", "testCall")
        result = invoke_json_I1(method, "{}", impl, self.rt, self.ctx)
        self.assertIsInstance(result, ResultErr)
