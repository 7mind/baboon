...
export class Out implements BaboonGeneratedLatest {
    ...
    public with(overrides: {profile?: UserProfile}): Out {
        return new Out(
            'profile' in overrides ? overrides.profile! : this._profile
        );
    }

    public static fromPlain(obj: {profile: UserProfile}): Out {
        return new Out(
            obj.profile
        );
    }
    ...
    public static readonly BaboonTypeIdentifier = 'mcp.mux.stub/UserService/createUser#out'
...
export class Out_JsonCodec {
    public encode(ctx: BaboonCodecContext, value: Out): unknown {
        ...
        return {
            "profile": UserProfile_JsonCodec.instance.encode(BaboonCodecContext.Default, value.profile),
        }
    }
    public decode(ctx: BaboonCodecContext, json: unknown): Out {
        ...
        return new Out (
            UserProfile_JsonCodec.instance.decode(BaboonCodecContext.Default, obj["profile"]),
        )
    }
...
export class Out_UEBACodec {
    ...
    public decode(ctx: BaboonCodecContext, reader: BaboonBinReader): Out {
        ...
        const profile = UserProfile_UEBACodec.instance.decode(ctx, reader);
        return new Out(
            profile,
        );
    }
