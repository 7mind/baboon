...
export async function invokeJson_OrderService(
    ...
    switch (method.methodName) {
        case "placeOrder": {
            let decoded: placeorder_In;
            try {
                decoded = placeorder_In_JsonCodec.instance.decode(BaboonCodecContext.Default, JSON.parse(data));
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'DecoderFailed', method, error: ex });
            }
            let output: placeorder_Out;
            try {
                output = await impl.placeOrder(decoded);
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'CallFailed', method, domainError: ex });
            }
            try {
                return rt.pure<BaboonWiringError, string>(JSON.stringify(placeorder_Out_JsonCodec.instance.encode(BaboonCodecContext.Default, output)));
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'EncoderFailed', method, error: ex });
            }
        }
        case "cancelOrder": {
            let decoded: cancelorder_In;
            try {
                decoded = cancelorder_In_JsonCodec.instance.decode(BaboonCodecContext.Default, JSON.parse(data));
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'DecoderFailed', method, error: ex });
            }
            let output: cancelorder_Out;
            try {
                output = await impl.cancelOrder(decoded);
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'CallFailed', method, domainError: ex });
            }
            try {
                return rt.pure<BaboonWiringError, string>(JSON.stringify(cancelorder_Out_JsonCodec.instance.encode(BaboonCodecContext.Default, output)));
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, string>({ tag: 'EncoderFailed', method, error: ex });
            }
        }
...
export async function invokeUeba_OrderService(
    method: BaboonMethodId,
    data: Uint8Array,
    impl: OrderService,
    rt: IBaboonServiceRt,
    ...
    switch (method.methodName) {
        case "placeOrder": {
            let decoded: placeorder_In;
            try {
                decoded = (() => { const reader = new BaboonBinReader(data); return placeorder_In_UEBACodec.instance.decode(ctx, reader); })();
            } catch (ex: unknown) {
            ...
            try {
                return rt.pure<BaboonWiringError, Uint8Array>((() => { const writer = new BaboonBinWriter(); placeorder_Out_UEBACodec.instance.encode(ctx, output, writer); return writer.toBytes(); })());
            } catch (ex: unknown) {
        ...
        case "cancelOrder": {
            let decoded: cancelorder_In;
            try {
                decoded = (() => { const reader = new BaboonBinReader(data); return cancelorder_In_UEBACodec.instance.decode(ctx, reader); })();
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, Uint8Array>({ tag: 'DecoderFailed', method, error: ex });
            }
            let output: cancelorder_Out;
            ...
            try {
                return rt.pure<BaboonWiringError, Uint8Array>((() => { const writer = new BaboonBinWriter(); cancelorder_Out_UEBACodec.instance.encode(ctx, output, writer); return writer.toBytes(); })());
            } catch (ex: unknown) {
                return rt.fail<BaboonWiringError, Uint8Array>({ tag: 'EncoderFailed', method, error: ex });
            }
        }
...
export class OrderServiceJsonService implements IBaboonJsonService<Promise<BaboonEither<BaboonWiringError, string>>> {
...
export class OrderServiceUebaService implements IBaboonUebaService<Promise<BaboonEither<BaboonWiringError, Uint8Array>>> {
    readonly serviceName = "OrderService";
    private readonly impl: OrderService;
    private readonly rt: IBaboonServiceRt;
