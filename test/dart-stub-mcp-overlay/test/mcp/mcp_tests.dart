...
final _refProcessTagged = jsonDecode(r'''{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","properties":{"tagged":{"$ref":"#/$defs/mcp_stub_Tagged"}},"required":["tagged"],"$defs":{"mcp_stub_Tagged":{"oneOf":[{"$ref":"#/$defs/mcp_stub_Tagged_TagA"},{"$ref":"#/$defs/mcp_stub_Tagged_TagB"}],"description":"ADT discriminator-wrapper encoding: encoded as a single-key JSON object {\"<Branch>\": { ...branch fields... }} where the key is the branch's short name and the value is that branch's field object. Exactly one branch key is present. Known branches: TagA, TagB."},"mcp_stub_Tagged_TagA":{"type":"object","properties":{"id":{"type":"string"},"tag":{"type":"string"}},"required":["id","tag"]},"mcp_stub_Tagged_TagB":{"type":"object","properties":{"id":{"type":"string"},"weight":{"type":"integer","format":"int32"}},"required":["id","weight"]}}}''') as Map<String, dynamic>;
