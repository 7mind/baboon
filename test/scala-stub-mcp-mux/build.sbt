// Scala MCP muxer round-trip test project (T107).
//
// Minimal project for testing AbstractMcpMuxer[Ctx] over two freshly-generated
// Scala MCP server instances (UserService + OrderService from mcp-mux-stub-ok).
