...
object BaboonAnyBinCodec {
  fun encode(
      ...
      val anyMetaWriter = BaboonBinaryWriter()
      AnyMetaCodec.writeBin(value.meta, anyMetaWriter)
      val anyMetaBytes = anyMetaWriter.toByteArray()
  ...
  fun decode(wire: BaboonBinaryReader, expectedKind: Byte): AnyOpaqueUeba {
