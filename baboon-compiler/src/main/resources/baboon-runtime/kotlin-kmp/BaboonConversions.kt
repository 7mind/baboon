...
abstract class AbstractConversion<From : Any, To : Any>(
    private val fromClass: KClass<From>,
    private val toClass: KClass<To>,
    ...
    override val typeFrom: KClass<*> get() = fromClass
    override val typeTo: KClass<*> get() = toClass
}
...
abstract class AbstractBaboonConversions {
    ...
    private val typeConversions = mutableMapOf<KClass<*>, MutableList<Conversion>>()
    ...
    fun <C> convertWithContext(ctx: C?, from: BaboonGenerated, fromClass: KClass<*>, toClass: KClass<*>): BaboonGenerated {
        val key = ConversionKey(fromClass, toClass)
