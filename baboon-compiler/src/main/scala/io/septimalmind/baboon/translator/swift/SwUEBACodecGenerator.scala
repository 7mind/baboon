...
class SwUEBACodecGenerator(
  ...
  private def mkDecoder(tpe: TypeRef): TextTree[SwValue] = {
    tpe match {
      ...
      case _: TypeRef.Any => AnyPlaceholder.notSupportedYet("SwUEBACodecGenerator.mkDecoder")
    }
  }
  ...
  private def mkEncoder(tpe: TypeRef, ref: TextTree[SwValue], wref: TextTree[SwValue]): TextTree[SwValue] = {
    tpe match {
      ...
      case _: TypeRef.Any => AnyPlaceholder.notSupportedYet("SwUEBACodecGenerator.mkEncoder")
    }
  }
